 ...
 * @since AM 5.5.0
 */
public class SocialPkceConfigNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(SocialPkceConfigNodePlugin.currentVersion, 
				Collections.singletonList(SocialPkceConfigNode.class));
	}
	...
	public String getPluginVersion() {
		return SocialPkceConfigNodePlugin.currentVersion;
	}
}
